...
/**
 * Corrects rbt to ensure the RBT adheres to
 * the rules of the RBT structure.
 *
...
/**
 * Sets the root to BLACK. Should always and only be 
 * called on the root node of an rbt after it has been 
 * created or changed.
 *
