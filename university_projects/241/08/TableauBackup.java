...
public class TableauBackup {
    ...
    public void addValue(Integer value) {
        if (smallest == null){
            ...
            Cell nextRow = smallest;
            Integer row = addToRow(smallest, value);
            while (row != null){
                if (nextRow.below != null){
                    row = addToRow(nextRow.below, row);
                } else {
                    nextRow.below = new Cell(row);
                    nextRow.below.above = nextRow;
                    row = null;
                }
                nextRow = nextRow.below;
            }
        }
